...
open class SideMenuManager : NSObject {
     ...
     */
    @discardableResult open class func menuAddPanGestureToPresent(toViewController: UIViewController) -> UIPanGestureRecognizer {
        ...
        panGestureRecognizer.delegate = toViewController as? UIGestureRecognizerDelegate
        toViewController.view.addGestureRecognizer(panGestureRecognizer)
