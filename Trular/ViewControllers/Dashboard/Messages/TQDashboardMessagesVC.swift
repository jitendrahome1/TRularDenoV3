...
class TQDashboardMessagesVC: UIViewController,IndicatorInfoProvider,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if datasource.count > 0 {
            ...
            let dashboardMessagesCell : TQDashboardMessagesCell = self.tableView.dequeueReusableCell(withIdentifier: "dashboardMessagesCell") as! TQDashboardMessagesCell
            
            dashboardMessagesCell.dataSource = datasource[indexPath.row] as AnyObject
            
            return dashboardMessagesCell
        } else {
