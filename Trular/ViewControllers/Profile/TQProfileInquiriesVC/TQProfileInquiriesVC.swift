...
class TQProfileInquiriesVC: UIViewController,IndicatorInfoProvider,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if datasource.count > 0 {
            ...
            let profileInquiriesCell : TQProfileInquiriesCell = self.aTableView.dequeueReusableCell(withIdentifier: "profileInquiriesCell") as! TQProfileInquiriesCell
            
            profileInquiriesCell.dataSource = datasource[indexPath.row] as AnyObject
            
            return profileInquiriesCell
        } else {
