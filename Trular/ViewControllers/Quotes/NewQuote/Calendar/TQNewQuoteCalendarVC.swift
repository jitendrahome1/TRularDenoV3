...
class TQNewQuoteCalendarVC: UIViewController,IndicatorInfoProvider,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        datasource = [["invitationType":"Call","notifDetails":"Call with customer"],
                      ["invitationType":"Chat","notifDetails":"Chat with customer"]]
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if datasource.count > 0 {
            ...
            dashboardInvitationsCell.inviteActionBtn.isHidden = true
    ...
    func indicatorInfo(for pagerTabStripController: PagerTabStripViewController) -> IndicatorInfo {
        ...
        return IndicatorInfo.init(title: "CALENDAR")
    }
