...
class TQLandingPageVC: TQBaseTableViewController {
    ...
    @IBAction func createAccount(_ sender: Any) {
        ...
        containerVC.didPressLogin = false
        TQHelper.sharedInstance.registrationInfoDict = Dictionary<String,AnyObject>()
    ...
    @IBAction func login(_ sender: Any) {
        ...
        TQHelper.sharedInstance.loginInfoDict = Dictionary<String,AnyObject>()
