...
class TQSelectOwnerVC: TQBaseTableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.setNavigationTitle(title: "Calendar", titleColor: .colorWithHexString("#404041"), subtitle: "Create an event"+bulletUnicode+"Owner", subtitleColor: .lightGray)
    }
