//
//  TQClientCallHistoryController.swift
//  Trular
//
...
class TQClientCallHistoryController: TQBaseViewController,UITableViewDataSource,UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let clientListCell : TQClientCallHistoryCell = self.aTableView.dequeueReusableCell(withIdentifier: "TQClientCallHistoryCell") as! TQClientCallHistoryCell
