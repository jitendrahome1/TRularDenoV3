...
class TQBasePagerVC: ButtonBarPagerTabStripViewController {
    ...
    func setNavigationTitle(title:String, titleColor:UIColor,subtitle:String, subtitleColor:UIColor) {
        ...
        let titleString = NSAttributedString(string: title as String, attributes: [NSFontAttributeName:UIFont.boldSystemFont(ofSize: 16),NSForegroundColorAttributeName: titleColor,NSParagraphStyleAttributeName: paragraphStyle])
        fullTitle.append(titleString)
        
        if subtitle.characters.count > 0 {
            
            let subtitleString = NSAttributedString(string: "\n"+subtitle as String, attributes: [NSFontAttributeName:UIFont.systemFont(ofSize: 10),NSForegroundColorAttributeName: subtitleColor,NSParagraphStyleAttributeName: paragraphStyle])
    ...
    func setTopicImage(profileImage:UIImage, userCount:Int) {
        ...
        userCountLbl.textAlignment = .center
